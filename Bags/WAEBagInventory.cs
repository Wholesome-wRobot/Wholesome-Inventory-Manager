...
public static class WAEBagInventory
{
    ...
    public static void Scan()
    {
        ...
        Logger.Log($"Bag Scan Process time : {(DateTime.Now.Ticks - dateBegin.Ticks) / 10000} ms");
    }
    ...
    public static void BagEquip()
    {
        ...
        Logger.Log($"Bag Equip Process time : {(DateTime.Now.Ticks - dateBegin.Ticks) / 10000} ms");
    }
}
